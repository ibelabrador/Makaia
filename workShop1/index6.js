...
const primerDigitoPasaporte = prompt("Ingrese el primer dígito de su pasaporte").toUpperCase();
const pasajeroNacional = primerDigitoPasaporte == "A";
console.log("¿El pasajero es Colombiano? " + pasajeroNacional);